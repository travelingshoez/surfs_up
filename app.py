...
# Add the a function with a return statement routing information. use f-strings.
def welcome():
    return(
    '''
...
# Create the Function and calculate the Precpitation. Query and create a dict.
def precipitation():
